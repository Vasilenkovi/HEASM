class ViewSelector:
    ...
    def querryForColComments(self): # querry to get comments to the collumn
        return "SELECT COLUMN_COMMENT FROM INFORMATION_SCHEMA.COLUMNS WHERE TABLE_SCHEMA = \'heasm\' AND TABLE_NAME = \'MAIN_VIEW\';"